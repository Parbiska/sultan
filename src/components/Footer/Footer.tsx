    ...
    return (
        <footer className={s.footer}>
            <div className={s.footer__content}>
                <div className={s.footer__info + ' ' + s.footer__element}>
                    <div className={s.footer__info__logo}>
                        <img src={logo} alt='logo' />
                    </div>
                    <div className={s.footer__info__text}>
                        Компания «Султан» — снабжаем розничные магазины товарами <br /> "под ключ" в Кокчетаве и
                        Акмолинской области
                    </div>
                    ...
                    <div className={s.footer__info__promotion}>
                        ...
                        <form className={s.footer__info__form}>
                            <input placeholder='Введите ваш E-mail' className={s.footer__info__input} type='email' />
                ...
                <div className={s.footer__menu + ' ' + s.footer__element}>
                    <div className={s.footer__title}>Меню сайта:</div>
                    <ul className={s.footer__list}>
                        <li className={s.footer__text}>
                            <a href='/'>О компании</a>
                        </li>
                        <li className={s.footer__text}>
                ...
                <div className={s.footer__catagories + ' ' + s.footer__element}>
                ...
                <div className={s.footer__contact + ' ' + s.footer__element}>
                ...
                <div className={s.footer__price + ' ' + s.footer__element}>
                    ...
                    <div className={s.footer__text}>Связь в мессенджерах:</div>
