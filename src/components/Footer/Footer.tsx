            ...
            <div className={s.footer__content}>
                ...
                <div className={s.footer__wrapper}>
                    <div className={s.footer__element}>
                        <div className={s.footer__element__title}>Меню сайта:</div>
                    ...
                    <div className={s.footer__element}>
                        <div className={s.footer__element__title}>Категории:</div>
                        <ul className={s.footer__element__list}>
                            <li className={s.footer__element__text}>
                    ...
                    <div className={s.footer__element}>
                        <div className={s.footer__element__title}>Скачать прайс-лист:</div>
                        ...
                        <div className={s.footer__element__text}>Связь в мессенджерах:</div>
                    ...
                    <div className={s.footer__element}>
                        <div className={s.footer__element__title}>Контакты:</div>
